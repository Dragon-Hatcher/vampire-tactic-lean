# Design of the `vampire` tactic

Moved out of the README, which a user of the library should be able to read without any
of this. Nothing here is needed to *use* the tactic.
