...
/-- error: vampire did not refute the goal: the goal does not follow from the hypotheses that were sent: vampire found a model of them and the negated goal. Try passing more hypotheses, raising the timeout, or `+mono`. -/
#guard_msgs in
