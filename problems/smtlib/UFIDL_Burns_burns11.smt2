...
(declare-fun p () Int)
(declare-fun q () Int)
(assert (not (=> (and (forall ((?p Int)) (=> (not (flag ?p)) (or (s_0 ?p) (s_1 ?p) (s_2 ?p)))) (forall ((?p Int)) (forall ((?q Int)) (=> (s_2 ?p) (not (s ?p ?q))))) (forall ((?p Int)) (forall ((?q Int)) (=> (and (< ?q ?p) (flag ?q) (or (s_5 ?p) (s_4 ?p) (and (s_3 ?p) (s ?p ?q)))) (and (not (s_5 ?q)) (not (and (s_4 ?q) (s ?q ?p))))))) (forall ((?p Int)) (=> (s_0 ?p) (not (or (s_1 ?p) (s_2 ?p) (s_3 ?p) (s_4 ?p) (s_5 ?p))))) (forall ((?p Int)) (=> (s_1 ?p) (not (or (s_2 ?p) (s_3 ?p) (s_4 ?p) (s_5 ?p))))) (forall ((?p Int)) (=> (s_2 ?p) (not (or (s_3 ?p) (s_4 ?p) (s_5 ?p))))) (forall ((?p Int)) (=> (s_3 ?p) (not (or (s_4 ?p) (s_5 ?p))))) (forall ((?p Int)) (=> (s_4 ?p) (not (s_5 ?p)))) (forall ((?r Int)) (let ((?v_0 (not (= ?r p)))) (=> (s_0 ?r) (not (or (s_1 ?r) (s_2 ?r) (and ?v_0 (=> ?v_0 (s_3 ?r))) (=> ?v_0 (s_4 ?r)) (s_5 ?r)))))) (forall ((?r Int)) (let ((?v_1 (not (= ?r p)))) (=> (s_1 ?r) (not (or (s_2 ?r) (and ?v_1 (=> ?v_1 (s_3 ?r))) (=> ?v_1 (s_4 ?r)) (s_5 ?r)))))) (forall ((?r Int)) (let ((?v_2 (not (= ?r p)))) (=> (s_2 ?r) (not (or (and ?v_2 (=> ?v_2 (s_3 ?r))) (=> ?v_2 (s_4 ?r)) (s_5 ?r)))))) (forall ((?r Int)) (let ((?v_3 (not (= ?r p)))) (=> (and ?v_3 (=> ?v_3 (s_3 ?r))) (not (or (=> ?v_3 (s_4 ?r)) (s_5 ?r)))))) (forall ((?r Int)) (=> (=> (not (= ?r p)) (s_4 ?r)) (not (s_5 ?r)))) (s_3 p) (forall ((?q Int)) (=> (< ?q p) (s p ?q)))) (and (forall ((?t Int)) (=> (not (flag ?t)) (or (s_0 ?t) (s_1 ?t) (s_2 ?t)))) (forall ((?t Int)) (forall ((?r Int)) (let ((?v_4 (not (= ?t p)))) (=> (s_2 ?t) (not (and ?v_4 (=> ?v_4 (s ?t ?r)))))))) (forall ((?t Int)) (forall ((?r Int)) (let ((?v_5 (not (= ?t p))) (?v_6 (not (= ?r p)))) (=> (and (< ?r ?t) (flag ?r) (or (s_5 ?t) (=> ?v_5 (s_4 ?t)) (and ?v_5 (=> ?v_5 (s_3 ?t)) ?v_5 (=> ?v_5 (s ?t ?r))))) (and (not (s_5 ?r)) (not (and (=> ?v_6 (s_4 ?r)) ?v_6 (=> ?v_6 (s ?r ?t)))))))))))))
(check-sat)
(exit)
