-- LIA_UltimateAutomizer_nested9_true_unreach_call_i_1887, from SMT-LIB (LIA, status unsat).
-- The vampire binary refutes it in 0.48s
-- (`--input_syntax smtlib2 --mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `LIA_UltimateAutomizer_nested9_true_unreach_call_i_1887.smt2`, beside this file. An SMT problem is a
