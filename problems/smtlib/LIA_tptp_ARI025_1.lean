-- LIA_tptp_ARI025_1, from SMT-LIB (LIA, status unsat).
-- The vampire binary refutes it in 0.01s
-- (`--input_syntax smtlib2 --mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `LIA_tptp_ARI025_1.smt2`, beside this file. An SMT problem is a
...
theorem T_ARI025_x3d1 (a1 : (¬(∃ (_x3fX : ℤ), (_x3fX ≤ 0)))) :
    False := by
  vampire [*]
