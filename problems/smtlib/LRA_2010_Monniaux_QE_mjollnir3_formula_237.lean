-- LRA_2010_Monniaux_QE_mjollnir3_formula_237, from SMT-LIB (LRA, status unsat).
-- The vampire binary refutes it in 0.01s
-- (`--input_syntax smtlib2 --mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `LRA_2010_Monniaux_QE_mjollnir3_formula_237.smt2`, beside this file. An SMT problem is a
...
theorem T_formula_237 (a1 : (∀ (v11_x3a0 : ℚ), (∀ (v10_x3a1 : ℚ), (∀ (v9_x3a2 : ℚ), (∀ (v8_x3a3 : ℚ), (∃ (v7_x3a4 : ℚ), (∃ (v6_x3a5 : ℚ), (∃ (v5_x3a6 : ℚ), (∃ (v4_x3a7 : ℚ), (∀ (v3_x3a8 : ℚ), (∀ (v2_x3a9 : ℚ), (∀ (v1_x3a10 : ℚ), (∀ (v0_x3a11 : ℚ), (((((((-7) * v2_x3a9) + ((-3) * v2_x3a9)) + (14 * v7_x3a4))) + ((-11) * v4_x3a7)) ≤ (-17))))))))))))))) :
    False := by
  vampire [*]
