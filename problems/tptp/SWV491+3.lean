-- SWV491+3, from TPTP v9.3.1 (SWV).
-- TPTP Status: Theorem.  The vampire binary refutes it in 0.14s
-- (`--mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `SWV491+3.p`, beside this file. This is its statement in Lean:
