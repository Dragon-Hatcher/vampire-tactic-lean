-- COM018+1, from TPTP v9.3.1 (COM).
-- TPTP Status: Theorem.  The vampire binary refutes it in 0.01s
-- (`--mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `COM018+1.p`, beside this file. This is its statement in Lean:
...
variable {t_xR t_xa t_xb t_xc t_xu t_xv t_xw : ι}
