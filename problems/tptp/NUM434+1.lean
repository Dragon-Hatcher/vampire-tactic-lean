-- NUM434+1, from TPTP v9.3.1 (NUM).
-- TPTP Status: Theorem.  The vampire binary refutes it in 0.26s
-- (`--mode portfolio --schedule casc --cores 1 -t 1`).
--
-- The problem itself is `NUM434+1.p`, beside this file. This is its statement in Lean:
...
variable {t_sz00 t_sz10 t_xa t_xb t_xp t_xq : ι}
