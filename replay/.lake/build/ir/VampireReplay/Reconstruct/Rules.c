...
// Module: VampireReplay.Reconstruct.Rules
// Imports: public import Init public meta import Init public import VampireReplay.InferenceRule public import VampireReplay.Reconstruct.Basic public import VampireReplay.Reconstruct.Rules.Arithmetic public import VampireReplay.Reconstruct.Rules.Avatar public import VampireReplay.Reconstruct.Rules.Clause public import VampireReplay.Reconstruct.Rules.Closure public import VampireReplay.Reconstruct.Rules.Congruence public import VampireReplay.Reconstruct.Rules.Clausify public import VampireReplay.Reconstruct.Rules.Definition public import VampireReplay.Reconstruct.Rules.Input public import VampireReplay.Reconstruct.Rules.Normalize public import VampireReplay.Reconstruct.Rules.Resolution public import VampireReplay.Reconstruct.Rules.Rewrite public import VampireReplay.Reconstruct.Rules.Simplify public import VampireReplay.Reconstruct.Rules.Skolem public import VampireReplay.Reconstruct.Rules.Splitting public import VampireReplay.Reconstruct.Rules.Subsumption
#include <lean/lean.h>
...
lean_object* initialize_Init(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_InferenceRule(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Basic(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Arithmetic(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Avatar(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Clause(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Closure(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Congruence(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Clausify(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Definition(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Input(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Normalize(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Resolution(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Rewrite(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Simplify(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Skolem(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Splitting(uint8_t builtin);
lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Subsumption(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_vampireReplay_VampireReplay_Reconstruct_Rules(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_InferenceRule(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Basic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Arithmetic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Avatar(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Clause(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Closure(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Congruence(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Clausify(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Definition(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Input(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Normalize(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Resolution(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Rewrite(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Simplify(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Skolem(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Splitting(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_vampireReplay_VampireReplay_Reconstruct_Rules_Subsumption(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
